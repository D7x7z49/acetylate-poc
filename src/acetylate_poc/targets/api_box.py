...
class BaseAPI(BaseModel):
    ...
    params: Annotated[Optional[Dict[str, Any]], Field(None, description="Query parameters for the request.")] = None
    headers: Annotated[Optional[Dict[str, Any]], Field(None, description="Headers to include in the request.")] = None
    data: Annotated[Optional[Dict[str, Any]], Field(None, description="Data to send in the body of the request.")] = (
        None
    )
    auth: Annotated[Optional[Dict[str, Any]], Field(None, description="Authentication credentials.")] = None
    cookies: Annotated[Optional[Dict[str, Any]], Field(None, description="Cookies to send with the request.")] = None
    proxies: Annotated[Optional[Dict[str, Any]], Field(None, description="Proxy settings for the request.")] = None
    verify: Annotated[Optional[bool], Field(True, description="Whether to verify SSL certificates.")] = True
    timeout: Annotated[Optional[float], Field(7.0, description="Timeout for the request in seconds.")] = 7.0
